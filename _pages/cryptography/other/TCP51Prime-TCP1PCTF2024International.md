...
$$a^{51} + 51 \cdot b^{51} \equiv 0$$

$$-51 \cdot b^{51}\equiv a^{51}$$

$$\sqrt[51]{-51 \cdot b^{51}}\equiv \sqrt[51]{a^{51}}$$

$$\sqrt[51]{-51} \cdot b \equiv a$$

$$\text{let } x = \sqrt[51]{-51}$$

$$b\cdot x + k\cdot p = a$$

$$
b \begin{bmatrix}x  \\ 1 \end{bmatrix}  + 
k   \begin{bmatrix}p  \\ 0 \end{bmatrix}  

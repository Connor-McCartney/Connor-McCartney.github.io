---
permalink: /cryptography/small-roots/corrupt-key-1-picoMini
title: corrupt-key-1 picoMini
---

<br>

We are given the 256 upper bits of p, which can be recovered by bruting some bits and then using Coppersmith's method. <br>
...
Once we have p it is standard RSA decryption:
